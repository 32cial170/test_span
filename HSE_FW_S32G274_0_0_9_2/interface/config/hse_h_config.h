...
*   @file    hse_h_config.h
*
*   @brief   HSE High features implementation.
*   @details This file contains the HSE High implementation features.
*
*   @addtogroup hse_h_config HSE High Features Implementation
...
==================================================================================================*/
...
#ifdef HSE_SPT_HASH
    #define HSE_SPT_MD5               /**< @brief Support for MD5 as defined  in IETF RFC-1321. */
    ...
    #define HSE_NUM_OF_SMR_ENTRIES          (4U)    /**< @brief   The supported number of SMR entries*/
...
#ifdef HSE_SPT_OTFAD
    #define HSE_NUM_OF_OTFAD_ENTRIES        (4U)     /**< @brief   The supported number of OTFAD entries*/
#endif
    ...
    #define HSE_SPT_TEMP_SENS_VIO_CONFIG             /**< @brief Support of enabling the temperature sensor violation in SNVS.
                                                                Temperature sensor configuration will be done by Bootrom if user has provided the Temperature  sensor configurations in DCD.*/
...
/**< \defdisable{#define,HSE_SPT_SELF_TEST}*/        /**< @brief Support self test */
    ...
    #define HSE_MAX_NUM_OF_SGT_ENTRIES  (32U)        /**< @brief Maximum number for SGT entries */
#endif
    ...
    #define HSE_SIPHASH_KEY_BIT_LENS      {64U, 128U}           /**< @brief  SipHash key bit lengths*/
#endif
