 ...
 * @details   It a 128-bit Application Debug Key/ Password to be set by the host in CUST_DEL LifeCycle.
 *            - Read:
 *                 - For HSE-H: Not allowed if ADKP has not been written yet. After it has been written, first 16 bytes of
 *                              SHA2_224(ADKP) can be requested via get ADKP attribute service.
...
/** @brief This macro describes the maximum filter duration that is possible for the physical tamper. The 
